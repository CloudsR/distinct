...
<div class="qq_login z"><?php if(!empty($_G['setting']['pluginhooks']['global_usernav_extra1'])) echo $_G['setting']['pluginhooks']['global_usernav_extra1'];?><?php if(!empty($_G['setting']['pluginhooks']['global_usernav_extra4'])) echo $_G['setting']['pluginhooks']['global_usernav_extra4'];?></div>	
<div id="um" class="z">	
...
<div class="uName"><?php echo $_G['member']['username'];?></div>
<i class="arrow-w"></i>
</div>
