...
block_get('123,124,125,126,127,128,130,129,131,132,133,134,135,136,139,138,140,137,141,106');?><?php include template('common/header2'); ?><link rel="stylesheet" type="text/css" id="time_diy" href="template/elec_201701_hx_dingzhi/style/css/menhu.css" />
...
<div class="cl" style=" margin-top: 20px;">
   <div class="wp" >
    <div style="float: left; width: 840px;">
         <!--[diy=diy_3]--><div id="diy_3" class="area"><div id="frameI5Yeg3" class="frame move-span cl frame-1"><div id="frameI5Yeg3_left" class="column frame-1-c"><div id="frameI5Yeg3_left_temp" class="move-span temp"></div><?php block_display('126');?></div></div><div id="framecM30M7" class="frame move-span cl frame-1"><div id="framecM30M7_left" class="column frame-1-c"><div id="framecM30M7_left_temp" class="move-span temp"></div><?php block_display('127');?></div></div><div id="frameqSpd3Y" class="frame move-span cl frame-1"><div id="frameqSpd3Y_left" class="column frame-1-c"><div id="frameqSpd3Y_left_temp" class="move-span temp"></div><?php block_display('128');?></div></div></div><!--[/diy]-->
         <div class="cl">
         <div class="cl" style="float: left; width: 380px;">
         <!--[diy=diy_4]--><div id="diy_4" class="area"><div id="frameO8WKsZ" class="frame move-span cl frame-1"><div id="frameO8WKsZ_left" class="column frame-1-c"><div id="frameO8WKsZ_left_temp" class="move-span temp"></div><?php block_display('130');?></div></div></div><!--[/diy]-->
         </div>
         <div class="cl" style="float: right; width: 380px;">
         <!--[diy=diy_5]--><div id="diy_5" class="area"><div id="frameS8QQjl" class="frame move-span cl frame-1"><div id="frameS8QQjl_left" class="column frame-1-c"><div id="frameS8QQjl_left_temp" class="move-span temp"></div><?php block_display('129');?></div></div></div><!--[/diy]-->
         </div>
         </div>
         </div>
         <div style="float: right; width: 340px;">
   ...
   <div class="box cl" style="padding-bottom: 10px;">
      ...
      <div class="cl" style="margin: 0 20px;">
         <div style="float: left; width: 370px; margin-right: 10px;">
            <!--[diy=diy_11]--><div id="diy_11" class="area"><div id="framewmIihU" class="frame move-span cl frame-1"><div id="framewmIihU_left" class="column frame-1-c"><div id="framewmIihU_left_temp" class="move-span temp"></div><?php block_display('139');?></div></div><div id="frameIZRL2R" class="frame move-span cl frame-1"><div id="frameIZRL2R_left" class="column frame-1-c"><div id="frameIZRL2R_left_temp" class="move-span temp"></div><?php block_display('138');?></div></div></div><!--[/diy]-->
         </div>
         <div style="float: left; width: 180px; margin-right: 10px;">
            <!--[diy=diy_12]--><div id="diy_12" class="area"><div id="framezcRfLD" class="frame move-span cl frame-1"><div id="framezcRfLD_left" class="column frame-1-c"><div id="framezcRfLD_left_temp" class="move-span temp"></div><?php block_display('140');?></div></div></div><!--[/diy]-->
         </div>
         <div style="float: left; width: 250px; margin-right: 10px;">
            <!--[diy=diy_13]--><div id="diy_13" class="area"><div id="frameUiXx48" class="frame move-span cl frame-1"><div id="frameUiXx48_left" class="column frame-1-c"><div id="frameUiXx48_left_temp" class="move-span temp"></div><?php block_display('137');?></div></div></div><!--[/diy]-->
         </div>
