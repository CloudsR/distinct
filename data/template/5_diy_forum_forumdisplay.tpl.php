...
0
|| checktplrefresh('data/diy/./template/elec_201701_hx_dingzhi//forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1501769299, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201701_hx_dingzhi/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201701_hx_dingzhi//forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1501769299, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201701_hx_dingzhi/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201701_hx_dingzhi//forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1501769299, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201701_hx_dingzhi/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201701_hx_dingzhi//forum/forumdisplay.htm', './template/elec_201701_hx_dingzhi/forum/forumdisplay_list.htm', 1501769299, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201701_hx_dingzhi/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201701_hx_dingzhi//forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1501769299, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201701_hx_dingzhi/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201701_hx_dingzhi//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1501769299, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201701_hx_dingzhi/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/elec_201701_hx_dingzhi//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1501769299, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/elec_201701_hx_dingzhi/', 'forum/forumdisplay')
;
block_get('56');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
...
<div class="cl">
                   <div class="side_tit" style="padding: 0 0 15px 0; margin: 10px 0 10px 0; border-bottom: 1px solid #F0F0F0;">
                      <h2 style="padding: 0 0 13px 0; border-bottom: 4px solid #f63756;"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><?php echo $_G['forum']['name'];?></a></h2>
                      <span class="management z" style="margin: 2px 0 0 20px;">
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum&amp;formhash=<?php echo FORMHASH;?>" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);">收藏本版 <em class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?>>(<span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span>)</em></a>
...
<?php } if($moderatedby) { ?><div>版主: <em><?php echo $moderatedby;?></em></div><?php } ?>
</div>
<?php } ?>
                   </div> 
</div>
...
<div id="forum_rules_<?php echo $_G['fid'];?>" style="<?php echo $collapse['forum_rules'];?>; margin-bottom: 20px; font-size: 14px;">
<div class="ptn xg2">本版规则：<?php echo $_G['forum']['rules'];?></div>
</div>
<?php } ?>
            
            <?php if((!$simplestyle || !$_G['forum']['allowside'] && $page == 1) && !empty($announcement)) { ?>
            <div style="margin-bottom: 20px; font-size: 16px;" class="gonggao"><?php if(empty($announcement['type'])) { ?><a href="forum.php?mod=announcement&amp;id=<?php echo $announcement['id'];?>#<?php echo $announcement['id'];?>" target="_blank">公告：<?php echo $announcement['subject'];?></a><?php } else { ?><a href="<?php echo $announcement['message'];?>" target="_blank">公告：<?php echo $announcement['subject'];?></a><?php } ?></div>
            <?php } ?>
...
<div class="cl" id="recommendgroups_<?php echo $_G['forum']['fid'];?>" style="padding: 12px; background: #FAFAFA; <?php echo $collapse['recommendgroups'];?>">
...
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/image_s.gif" alt="attach_img" title="图片附件" align="absmiddle" />
<?php } elseif($thread['attachment'] == 1) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/common.gif" alt="attachment" title="附件" align="absmiddle" />
...
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/digest_<?php echo $thread['digest'];?>.png" align="absmiddle" alt="digest" title="精华 <?php echo $thread['digest'];?>" />
<?php } if($thread['displayorder'] == 0) { if($thread['recommendicon'] && $filter != 'recommend') { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/recommend_<?php echo $thread['recommendicon'];?>.gif" align="absmiddle" alt="recommend" title="评价指数 <?php echo $thread['recommends'];?>" />
<?php } if($thread['heatlevel']) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/hot_<?php echo $thread['heatlevel'];?>.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
<?php } if($thread['rate'] > 0) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/agree.gif" align="absmiddle" alt="agree" title="帖子被加分" />
<?php } elseif($thread['rate'] < 0) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/disagree.gif" align="absmiddle" alt="disagree" title="帖子被减分" />
...
新窗口打开" target="_blank">
<?php if($thread['folder'] == 'lock') { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/folder_lock.gif" />
<?php } elseif($thread['special'] == 1) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/pollsmall.gif" alt="投票" />
<?php } elseif($thread['special'] == 2) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/tradesmall.gif" alt="商品" />
<?php } elseif($thread['special'] == 3) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/rewardsmall.gif" alt="悬赏" />
<?php } elseif($thread['special'] == 4) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/activitysmall.gif" alt="活动" />
<?php } elseif($thread['special'] == 5) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/debatesmall.gif" alt="辩论" />
<?php } elseif(in_array($thread['displayorder'], array(1, 2, 3, 4))) { ?>
<img src="template/elec_201701_hx_dingzhi/style/elecom_icon/pin_<?php echo $thread['displayorder'];?>.gif" alt="<?php echo $_G['setting']['threadsticky'][3-$thread['displayorder']];?>" />
<?php } ?>
</a>
...
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">发布新帖</a><?php } ?>
...
<div class="box_1 cl">
<div class="side_tit cl">
                        <span class="span-mark"></span>
                        <h2>推荐<?php echo $_G['setting']['navs']['3']['navname'];?></h2>
</div>
<div class="bm_c cl" style="padding: 0 23px;">
...
<?php } } ?>
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framei82z3b" class="frame move-span cl frame-1"><div id="framei82z3b_left" class="column frame-1-c"><div id="framei82z3b_left_temp" class="move-span temp"></div><?php block_display('56');?></div></div></div><!--[/diy]-->
</div>
