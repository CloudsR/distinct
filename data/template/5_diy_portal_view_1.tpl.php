...
0
|| checktplrefresh('data/diy/./template/elec_201701_hxzmt//portal/view_1.htm', './template/elec_201701_hx_dingzhi/portal/portal_comment.htm', 1501934813, 'diy', './data/template/5_diy_portal_view_1.tpl.php', 'data/diy/./template/elec_201701_hxzmt/', 'portal/view_1')
|| checktplrefresh('data/diy/./template/elec_201701_hxzmt//portal/view_1.htm', './template/default/common/seccheck.htm', 1501934813, 'diy', './data/template/5_diy_portal_view_1.tpl.php', 'data/diy/./template/elec_201701_hxzmt/', 'portal/view_1')
;
block_get('24,23');?><?php include template('common/header'); ?><link rel="stylesheet" type="text/css" href="template/elec_201701_hxzmt/style/css/pindao.css" />
...
jQuery(function() { 
            ...
            <div class="avatar_info cl">
              <div class="cl" style="float: left; width: 100%; overflow: hidden;">
                <p class="authors" style="margin: 0 0 5px 0; font-size: 14px;">
                  ...
                  <span style="float: right; margin-right: 20px; color: #3ca5f6;"><?php echo $cat['catname'];?></span>
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="tag_box cl" style="margin-bottom: 10px;"><span class="span-mark-author">发表评论</span></div>
...
EOF;
?>
<div class="y" style="margin: 6px -12px 0 10px;"><?php $sechash = !isset($sechash) ? 'S'.($_G['inajax'] ? 'A' : '').$_G['sid'] : $sechash.random(3);
...
<button type="submit" name="commentsubmit_btn" id="commentsubmit_btn" value="true" class="pn z">发表</button>
                </div>
                <?php } ?>
</form>
           </div>
...
<div id="comment" class="bm cl">
  ...
  <div id="comment_ul"> 
    ...
    <?php } ?>  
      ...
      <?php } ?> 
      <!--[diy=diycontentcomment]--><div id="diycontentcomment" class="area"><div id="frameplk6Bf" class="frame move-span cl frame-1"><div id="frameplk6Bf_left" class="column frame-1-c"><div id="frameplk6Bf_left_temp" class="move-span temp"></div><?php block_display('24');?></div></div></div><!--[/diy]--> 
    </div>
  </div>
  <div class="sd pph" style="width: 340px; padding: 0; box-shadow: none; background: none;">
    <!--[diy=diy2]--><div id="diy2" class="area"><div id="frameqmSrZl" class="frame move-span cl frame-1"><div id="frameqmSrZl_left" class="column frame-1-c"><div id="frameqmSrZl_left_temp" class="move-span temp"></div><?php block_display('23');?></div></div></div><!--[/diy]-->
