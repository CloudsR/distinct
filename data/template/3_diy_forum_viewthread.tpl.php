...
0
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/macastudio/forum/viewthread_node.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/macastudio/forum/viewthread_fastpost.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/macastudio/forum/viewthread_fastpost2.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/macastudio/forum/viewthread_node_body.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/default/common/seditor.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/default/common/upload.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/default/common/seditor.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/default/common/upload.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/default/common/seccheck.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/macastudio//forum/viewthread.htm', './template/default/common/seccheck.htm', 1512028022, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/macastudio/', 'forum/viewthread')
;
block_get('86,84,85');?><?php include template('common/header'); $ucthread = C::t('forum_thread')->fetch_all_by_authorid($_G['forum_thread']['authorid'], 0,8);?><?php $ucauthor = DB::fetch_first("SELECT `follower`,`threads`,`following` FROM ".DB::table('common_member_count')." WHERE uid = ".$_G['forum_thread']['authorid']);?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
<?php if($modmenu['thread'] || $modmenu['post']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>

<link rel="stylesheet" type="text/css" href="template/elec_201701_hx_dingzhi/style/css/thread.css" />
...
<?php if($_G['setting']['close_leftinfo_userctrl']) { ?>
                ...
                <?php if(!$close_leftinfo) { ?>
                    <a onclick="setcookie('close_leftinfo', 1);location.reload();" title="收起左侧" class="btn_s_close" href="javascript:;">切换媒体风格</a>
                <?php } else { ?>
                    <a onclick="setcookie('close_leftinfo', 2);location.reload();" title="开启左侧" class="btn_s_open" href="javascript:;">切换论坛风格</a>
                <?php } ?>
...
<div class="z">
<?php echo $navigation;?> <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>"><?php echo $_G['forum_thread']['short_subject'];?></a>
</div>
</div>
...
<li class="cl" style="margin-top: 30px;"><a title="评论" class="bds_reply" id="divGoToBottom" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;"><i class="icon-article-col">回复</i></a></li>
...
<li class="cl" style="border-bottom: 0;"><a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" id="k_favorite" class="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" title="收藏本帖"><i class="icon-article-col">收藏</i></a></li>
</div>
...
<?php } ?>
    <div class="mn <?php if($close_leftinfo) { ?>mn2<?php } ?>" <?php if(!$close_leftinfo) { ?> style="width:100%">
    	
        <div class="elecfbhf">
                <a class="elec_pst_btn" onclick="showWindow('newthread', 'forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>')" href="javascript:;" title="发新帖">发布主题</a>
            <?php if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
                <a class="elec_rpl_btn" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">回复</a>
            <?php } ?>
                <div class="clear"></div>
            </div>
        <?php } ?>
    ...
    <div id="postlist" class="pl bm <?php if(!$close_leftinfo) { ?>elecconone<?php } else { ?>elec_all_replies<?php } ?>">
  		<?php if($_G['forum_thread']['replycredit'] > 0 || $rushreply) { ?>
            <div id="pl_top" class="box mb20">
                <table cellspacing="0" cellpadding="0">
                    <tr class="ad">
                        <td class="pls"></td>
                        <td class="plc" <?php if(!$close_leftinfo) { ?> style="width:100%; padding: 0 20px;"<?php } ?>></td>
                    </tr>
...
jQuery(this).children(".vwthdewmsub").hide();
        ...
        <table cellspacing="0" cellpadding="0" class="ad" style=" display:none;">
            <tr>
                ...
                <td class="plc" <?php if(!$close_leftinfo) { ?> style="width:100%; padding: 0 20px;"<?php } ?>>
                <?php } ?>
                </td>
            </tr>
        </table>
...
<?php if(!$post['anonymous'] && $postshowavatars && $showavatars) { ?>
    ...
    <?php } else { ?>
    	<img src="<?php echo $_G['style']['styleimgdir'];?>/hidden.png" />
    <?php } ?>
</div>
<?php } if($close_leftinfo && !$post['first']) { ?>
<div class="viewinfo">
...
<?php } } else { ?>
            	<div class="avatar"><img src="<?php echo $_G['style']['styleimgdir'];?>/hidden.png" /></div>
<div class="pi">
                    <div class="authi">
...
<?php } ?>
<td class="plc"<?php if(!$close_leftinfo) { ?> style="width:100%; padding: 0 20px;"<?php } ?>>
<div class="pi<?php if($close_leftinfo) { ?> pi2<?php } if($close_leftinfo && !$post['first']) { ?> pi3<?php } ?>">
...
<?php } ?>
                ...
                <?php } ?>
                <?php if(!$close_leftinfo || !$post['first']) { ?>
<strong class="<?php if($close_leftinfo) { ?>floors<?php } ?> y" style="margin: 0;">
...
<?php } if($close_leftinfo) { ?><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" style="color: #333333;"><?php echo $post['author'];?></a><?php echo $authorverifys;?><?php } if($close_leftinfo) { } ?>
<em id="authorposton<?php echo $post['pid'];?>" <?php if($close_leftinfo) { ?>style="margin: 0 10px 0 20px;"<?php } ?>><?php echo $post['dateline'];?></em>
...
<?php } ?>
<div class="<?php if(!$_G['forum_thread']['special']) { ?>t_fsz<?php } else { ?>pcbs<?php } ?>" <?php if($close_leftinfo) { ?>style="min-height: 50px;"<?php } ?>>
...
<div id="vfastpost" class="fullvfastpost" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>>				
...
<div id="comment_<?php echo $post['pid'];?>" class="cm" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>>
...
<dl id="ratelog_<?php echo $post['pid'];?>" class="rate<?php if(!empty($_G['cookie']['ratecollapse'])) { ?> rate_collapse<?php } ?>" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>>
...
<tr><td class="plc plm" <?php if(!$close_leftinfo) { ?> style="width:100%; padding: 0 20px;"<?php } ?>>
...
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖"><img src="<?php echo $_G['style']['styleimgdir'];?>/favourite.png" alt="收藏" /><div class="elecicon_bottom"><span class="elecsc">收藏</span><span id="favoritenumber"<?php if(!$_G['forum_thread']['favtimes']) { } ?>><?php echo $_G['forum_thread']['favtimes'];?></span></div></a>
...
<a class="followp" href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散"><img src="<?php echo $_G['style']['styleimgdir'];?>/zhuanbo.png" alt="转播" />
...
<a class="sharep" href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);" title="分享推精华"><img src="<?php echo $_G['style']['styleimgdir'];?>/share.png" alt="分享" /><div class="elecicon_bottom"><span class="elecsc">分享<?php if($_G['forum_thread']['sharetimes']) { ?></span><span id="sharenumber"><?php echo $_G['forum_thread']['sharetimes'];?></span><?php } ?></div></a>
<?php } if(!$_G['forum']['disablecollect'] && helper_access::check_module('collection')) { ?>
<a href="forum.php?mod=collection&amp;action=edit&amp;op=addthread&amp;tid=<?php echo $_G['tid'];?>" id="k_collect" onclick="showWindow(this.id, this.href);return false;" onmouseover="this.title = $('collectionnumber').innerHTML + ' 人淘帖'" title="淘好帖进专辑"><img src="<?php echo $_G['style']['styleimgdir'];?>/taotie.png" alt="分享" />
...
<div class="elecmean mtw mbw" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>>
<h3 class="pbm mbm bbda elecrelatedthreads"><span>相关帖子</span></h3>
<ul class="xl xl2 cl electhreadslists"><?php if(is_array($post['relateitem'])) foreach($post['relateitem'] as $var) { ?><li>
...
<td class="pls"></td>
<?php } ?>
<td class="plc" style="overflow:visible;<?php if(!$close_leftinfo ) { ?>--> width:100%; padding: 0 20px;<?php } ?>">
<div class="po hin" <?php if($close_leftinfo) { ?>style="border-top: 0;"<?php } ?>>
<?php if(!$post['first'] && $modmenu['post']) { ?>
<span class="y" style="color: #BBBBBB;">
...
<div class="reply_tit cl">
        ...
        <?php if(!$rushreply) { ?>
                <?php if($ordertype != 1) { ?>
                    <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=1"  class="show z" style="color: #999999;">倒序浏览</a>
                <?php } else { ?>
                    <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=2"  class="show z" style="color: #999999;">正序浏览</a>
                <?php } ?>
            <?php } ?>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_endline'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_endline'][$postcount];?>
    ...
    <div class="pgs mtm mbm cl" <?php if($close_leftinfo) { ?>style="margin-bottom: 20px !important;"<?php } ?>>
        <?php echo $multipage;?>
        <span class="pgb y"<?php if($_G['setting']['visitedforums']) { ?> id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"<?php } ?> <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>><a href="<?php echo $upnavlink;?>">返回列表</a></span>
        <?php if(!$_G['forum_thread']['is_archived']) { ?>
            <a class="elec_pst_btn" <?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>>发表新帖</a>
        <?php } ?>
        <?php if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
            <a class="elec_rpl_btn" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>>回复</a>
        <?php } ?>
    </div>
...
<table cellspacing="0" cellpadding="0">
<tr>
<td class="pls" <?php if($close_leftinfo) { ?>style="display: none;"<?php } ?>>
...
<td class="plc" <?php if(!$close_leftinfo) { ?> style="width:100%; padding: 20px;"<?php } ?>>
<?php } ?>
...
<div class="tag_box cl" style="line-height: 30px; padding: 0 0 0 10px; margin: 0 0 25px 0; border-bottom: 0; border-left: 3px solid #66CC99; font-size: 24px;"><span>发表评论</span></div>
<div id="f_pst" class="pl" style="border: 0;">
<form method="post" autocomplete="off" id="fastpostform" action="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;replysubmit=yes<?php if($_GET['ordertype'] != 1) { ?>&amp;infloat=yes&amp;handlekey=fastpost<?php } if($_GET['from']) { ?>&amp;from=<?php echo $_GET['from'];?><?php } ?>"<?php if($_GET['ordertype'] != 1) { ?> onSubmit="return fastpostvalidate(this)"<?php } ?>>
<?php if(empty($_GET['from'])) { ?>
<table cellspacing="0" cellpadding="0">
<tr>
...
<?php if(empty($_GET['from']) && $_G['setting']['fastsmilies']) { ?><div id="fastsmiliesdiv" class="y"><div id="fastsmiliesdiv_data"><div id="fastsmilies"></div></div></div><?php } ?>
<div<?php if(empty($_GET['from']) && $_G['setting']['fastsmilies']) { ?> class="hasfsl"<?php } ?> id="fastposteditor">
<div class="tedt<?php if(!($_G['forum_thread']['special'] == 5 && empty($firststand))) { ?> mtn<?php } ?>" style="border: 1px solid #F0F0F0;">
...
<div class="area" style="background: #FAFAFA;">
<?php if($allowfastpost) { ?>
<textarea rows="6" cols="80" name="message" id="fastpostmessage" onKeyDown="seditor_ctlent(event, <?php if($_GET['ordertype'] != 1) { ?>'fastpostvalidate($(\'fastpostform\'))'<?php } else { ?>'$(\'fastpostform\').submit()'<?php } ?>);" tabindex="4" class="pt"<?php echo getreplybg($_G['forum']['replybg']);?> style="background: #FAFAFA;"></textarea>
<?php } else { ?>
<div class="pt hm" style="background: #FAFAFA;">
<?php if(!$_G['uid']) { if(!$_G['connectguest']) { ?>
您需要登录后才可以回帖 <a href="member.php?mod=logging&amp;action=login" onclick="showWindow('login', this.href)" class="xi2">登录</a> | <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2"><?php echo $_G['setting']['reglinkname'];?></a>
<?php } else { ?>
您需要 <a href="member.php?mod=connect" class="xi2">完善帐号信息</a> 或 <a href="member.php?mod=connect&amp;ac=bind" class="xi2">绑定已有帐号</a> 后才可以发帖
...
<input type="hidden" name="subject" value="  " />
<p class="ptm pnpost">
<a href="home.php?mod=spacecp&amp;ac=credit&amp;op=rule&amp;fid=<?php echo $_G['fid'];?>" class="y" target="_blank" style="display: none;">本版积分规则</a>
<button <?php if($allowpostreply) { ?>type="submit" <?php } elseif(!$_G['uid']) { ?>type="button" onclick="showWindow('login', 'member.php?mod=logging&action=login&guestmessage=yes')" <?php } if(!$seccodecheck) { ?>onmouseover="checkpostrule('seccheck_fastpost', 'ac=reply');this.onmouseover=null" <?php } ?>name="replysubmit" id="fastpostsubmit" class="pn pnc vm" value="replysubmit" tabindex="5" style="width: auto;
height: 60px;
line-height: 60px;
color: #fff;
...
<?php } ?>
    ...
    <?php if($close_leftinfo) { ?><!--[diy=diyfastposttop]--><div id="diyfastposttop" class="area"><div id="frameA0Snsl" class="frame move-span cl frame-1"><div id="frameA0Snsl_left" class="column frame-1-c"><div id="frameA0Snsl_left_temp" class="move-span temp"></div><?php block_display('86');?></div></div></div><!--[/diy]--><?php } ?>
...
<div class="elecuser">
<a class="eleclzname" href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank" title="访问我的空间" c="1"><?php echo $_G['forum_thread']['author'];?></a><?php if(is_array($postlist)) foreach($postlist as $post) { if($post['first']) { if(is_array($post['verifyicon'])) foreach($post['verifyicon'] as $vid) { ?><a href="home.php?mod=spacecp&amp;ac=profile&amp;op=verify&amp;vid=<?php echo $vid;?>" target="_blank"><?php if($_G['setting']['verify'][$vid]['icon']) { ?><img src="<?php echo $_G['setting']['verify'][$vid]['icon'];?>" class="vm" alt="<?php echo $_G['setting']['verify'][$vid]['title'];?>" title="<?php echo $_G['setting']['verify'][$vid]['title'];?>" /><?php } else { ?><?php echo $_G['setting']['verify'][$vid]['title'];?><?php } ?></a>
