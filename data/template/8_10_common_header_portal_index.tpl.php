...
0
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_common.htm', 1510712688, '10', './data/template/8_10_common_header_portal_index.tpl.php', './template/xinrui_iuni', 'common/header_portal_index')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_qmenu.htm', 1510712688, '10', './data/template/8_10_common_header_portal_index.tpl.php', './template/xinrui_iuni', 'common/header_portal_index')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/xinrui_iuni/common/pubsearchform.htm', 1510712688, '10', './data/template/8_10_common_header_portal_index.tpl.php', './template/xinrui_iuni', 'common/header_portal_index')
;?>
