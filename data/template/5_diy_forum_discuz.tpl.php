...
block_get('52,51,55');?><?php include template('common/header'); ?><script src="template/elec_201701_hx_dingzhi/style/js/jquery.superslide.js" type="text/javascript" type="text/javascript"></script>
...
<div class="cl">
 <div style="float: left; width: 800px;">
   <!--[diy=diy_banner]--><div id="diy_banner" class="area"><div id="framej81HV2" class="frame move-span cl frame-1"><div id="framej81HV2_left" class="column frame-1-c"><div id="framej81HV2_left_temp" class="move-span temp"></div><?php block_display('52');?></div></div></div><!--[/diy]-->
 </div>
 <div style="float: right; width: 340px;">
   <!--[diy=diy_banner_r]--><div id="diy_banner_r" class="area"><div id="framehKOpTt" class="frame move-span cl frame-1"><div id="framehKOpTt_left" class="column frame-1-c"><div id="framehKOpTt_left_temp" class="move-span temp"></div><?php block_display('51');?></div></div></div><!--[/diy]-->
 </div>
</div>
...
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framen1chCB" class="frame move-span cl frame-1"><div id="framen1chCB_left" class="column frame-1-c"><div id="framen1chCB_left_temp" class="move-span temp"></div><?php block_display('55');?></div></div></div><!--[/diy]-->
</div>
            <script type="text/javascript">
jQuery.noConflict();
