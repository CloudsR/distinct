...
0
|| checktplrefresh('data/diy/./template/elec_201701_hxzmt//portal/view_4.htm', './template/elec_201701_hx_dingzhi/portal/portal_comment.htm', 1501934821, 'diy', './data/template/5_diy_portal_view_4.tpl.php', 'data/diy/./template/elec_201701_hxzmt/', 'portal/view_4')
|| checktplrefresh('data/diy/./template/elec_201701_hxzmt//portal/view_4.htm', './template/default/common/seccheck.htm', 1501934821, 'diy', './data/template/5_diy_portal_view_4.tpl.php', 'data/diy/./template/elec_201701_hxzmt/', 'portal/view_4')
;
block_get('27,26');?><?php include template('common/header'); ?><link rel="stylesheet" type="text/css" href="template/elec_201701_hxzmt/style/css/pindao.css" />
...
<div id="comment" class="bm cl">
  ...
  <div id="comment_ul"> 
    ...
    <?php } ?>  
      ...
      <?php } ?> 
      <!--[diy=diycontentcomment]--><div id="diycontentcomment" class="area"><div id="framej5zwIU" class="frame move-span cl frame-1"><div id="framej5zwIU_left" class="column frame-1-c"><div id="framej5zwIU_left_temp" class="move-span temp"></div><?php block_display('27');?></div></div></div><!--[/diy]--> 
    </div>
  </div>
  <div class="sd pph" style="width: 340px; padding: 0; box-shadow: none; background: none;">
    <!--[diy=diy2]--><div id="diy2" class="area"><div id="framePLr0GR" class="frame move-span cl frame-1"><div id="framePLr0GR_left" class="column frame-1-c"><div id="framePLr0GR_left_temp" class="move-span temp"></div><?php block_display('26');?></div></div></div><!--[/diy]-->
