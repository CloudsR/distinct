...
0
|| checktplrefresh('./template/elec_201701_hx_dingzhi/common/header.htm', './template/elec_201701_hx_dingzhi/common/header_common.htm', 1501769290, '6', './data/template/5_6_common_header_portal_portalcp.tpl.php', './template/elec_201701_hx_dingzhi', 'common/header_portal_portalcp')
|| checktplrefresh('./template/elec_201701_hx_dingzhi/common/header.htm', './template/elec_201701_hx_dingzhi/common/pubsearchform.htm', 1501769290, '6', './data/template/5_6_common_header_portal_portalcp.tpl.php', './template/elec_201701_hx_dingzhi', 'common/header_portal_portalcp')
|| checktplrefresh('./template/elec_201701_hx_dingzhi/common/header.htm', './template/default/common/header_qmenu.htm', 1501769290, '6', './data/template/5_6_common_header_portal_portalcp.tpl.php', './template/elec_201701_hx_dingzhi', 'common/header_portal_portalcp')
;?>
...
<?php } ?><?php echo adshow("headerbanner/wp a_h");?><div id="elecom_nav2">
  <div class="wp cl">
...
<ul id="scbar_type_menu" class="p_pop pop2" style="display: none;"><?php echo implode('', $slist);; ?></ul>
...
jQuery('.elecom_search').fadeOut(300);
    ...
    <div class="y" style="margin-right: 18px;"><a href="javascript:;" id="qmenu" onMouseOver="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})" style="font-size: 16px;">快捷导航</a></div>
    </div>
  </div>
