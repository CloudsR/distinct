...
0
|| checktplrefresh('./template/elec_201701_hx_dingzhi/common/header2.htm', './template/elec_201701_hx_dingzhi/common/header_common.htm', 1501769254, '6', './data/template/5_6_common_header2.tpl.php', './template/elec_201701_hx_dingzhi', 'common/header2')
|| checktplrefresh('./template/elec_201701_hx_dingzhi/common/header2.htm', './template/elec_201701_hx_dingzhi/common/pubsearchform2.htm', 1501769254, '6', './data/template/5_6_common_header2.tpl.php', './template/elec_201701_hx_dingzhi', 'common/header2')
|| checktplrefresh('./template/elec_201701_hx_dingzhi/common/header2.htm', './template/default/common/header_qmenu.htm', 1501769254, '6', './data/template/5_6_common_header2.tpl.php', './template/elec_201701_hx_dingzhi', 'common/header2')
;?>
...
<?php } ?><?php echo adshow("headerbanner/wp a_h");?><div id="elecom_nav">
  ...
  <div id="top_bar" class="cl"> 
    <div class="wp cl">
     <div class="left_bars z" style="line-height: 40px; color: #666666; font-size: 16px;"><?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } ?>
<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra1'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra1'];?>
 </div>
  ...
  <div class="logo_box cl">
   <div class="wp cl" style="height: 80px; padding: 50px 0;">
     <!-- 站点LOGO -->
