...
<div class="atd cl">
<ul><?php $clicknum = 0;?><?php if(is_array($clicks)) foreach($clicks as $key => $value) { $clicknum = $clicknum + $value['clicknum'];?><?php $value['height'] = $maxclicknum?intval($value['clicknum']*50/$maxclicknum):0;?><li>
...
<img src="template/elec_201701_hx_dingzhi/style/punch.png" alt="" />
...
<h3 class="mbm xs1" style="display: none;">
...
<div id="trace_div" class="xs1" style="display: none;">
