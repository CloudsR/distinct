...
<?php if($_G['setting']['icp']) { ?>( <a href="http://www.suibianlu.com/" target="_blank"><?php echo $_G['setting']['icp'];?></a> )<?php } ?>
...
<p>Powered by <a href="http://www.suibianlu.com" target="_blank">Discuz!</a> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://www.suibianlu.com" target="_blank">Licensed</a><?php } ?></p>

<p class="xs0">&copy; 2015-2016 <a href="http://www.suibianlu.com" target="_blank">www.suibianlu.com.</a></p>
