...
0
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_common.htm', 1510712697, '10', './data/template/8_10_common_header_portal_list.tpl.php', './template/xinrui_iuni', 'common/header_portal_list')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/default/common/header_qmenu.htm', 1510712697, '10', './data/template/8_10_common_header_portal_list.tpl.php', './template/xinrui_iuni', 'common/header_portal_list')
|| checktplrefresh('./template/xinrui_iuni/common/header.htm', './template/xinrui_iuni/common/pubsearchform.htm', 1510712697, '10', './data/template/8_10_common_header_portal_list.tpl.php', './template/xinrui_iuni', 'common/header_portal_list')
;?>
...
<div class="y"><?php include template('common/header_userstatus'); ?> 
<?php if(check_diy_perm($topic)) { ?><?php echo $diynav;?><?php } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">切换风格</a><?php } ?>
</div>
</div>
</div>
...
<div class="wp cl"><?php $mnid = getcurrentnav();?><h1 class="logo z"><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h1>
...
<?php echo $_G['setting']['menunavs'];?><?php echo adshow("subnavbanner/a_mu");?><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
<div id="scbar" class="<?php if($_G['setting']['srchhotkeywords'] && count($_G['setting']['srchhotkeywords']) > 5) { ?>scbar_narrow <?php } ?>cl y">
