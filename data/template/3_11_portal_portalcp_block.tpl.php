...
0
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1512027979, '11', './data/template/3_11_portal_portalcp_block.tpl.php', './template/macastudio', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1512027979, '11', './data/template/3_11_portal_portalcp_block.tpl.php', './template/macastudio', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1512027979, '11', './data/template/3_11_portal_portalcp_block.tpl.php', './template/macastudio', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1512027979, '11', './data/template/3_11_portal_portalcp_block.tpl.php', './template/macastudio', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_nav.htm', 1512027979, '11', './data/template/3_11_portal_portalcp_block.tpl.php', './template/macastudio', 'portal/portalcp_block')
