...
<td valign="top" width="100%" class="mask">
	<iframe src="$basescript?$extra" id="main" name="main" width="100%" height="100%" frameborder="0" scrolling="yes" style="overflow: visible; padding: 10px 0 0 0;"></iframe>
</td>
</tr>
</table>
